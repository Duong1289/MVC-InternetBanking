    ...
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Branches != null ? 
                          ...
                          Problem("Entity set 'InternetBankingContext.Branches'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BranchName,Address,Location,Phone,Email,BankId")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Id,BranchName,Address,Location,Phone,Email,BankId")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
