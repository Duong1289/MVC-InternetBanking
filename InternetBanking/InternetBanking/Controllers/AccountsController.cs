...
//        public async Task<IActionResult> Create([Bind("AccountNumber,Balance,OpenDate,ExpireDate,Status,AccountTypeId,CustomerPersonalId")] Account account)
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(string id, [Bind("AccountNumber,Balance,OpenDate,ExpireDate,Status,AccountTypeId,CustomerPersonalId")] Account account)
//        {
